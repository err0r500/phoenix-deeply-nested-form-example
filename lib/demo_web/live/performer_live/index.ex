defmodule DemoWeb.PerformerLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :performers, Catalog.list_performers())}
  end
  ...
  @impl true
  def handle_info({DemoWeb.PerformerLive.FormComponent, {:saved, performer}}, socket) do
    {:noreply, stream_insert(socket, :performers, performer)}
  end

  @impl true
  def handle_event("delete", %{"id" => id}, socket) do
    performer = Catalog.get_performer!(id)
    {:ok, _} = Catalog.delete_performer(performer)
